...
import com.isaque.bookstore.service.exceptions.DataIntegrityViolationException;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> validationErrors(MethodArgumentNotValidException e) {
		...
		ValidationError error = new ValidationError(System.currentTimeMillis(), HttpStatus.NO_CONTENT.value(),
